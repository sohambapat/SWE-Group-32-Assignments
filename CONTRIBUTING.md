...
The following is a set of guidelines for contributing to HW-Group32 and its packages, which are hosted in the [Group Repository](https://github.com/Safaa26/Software-Engineering-Fall-22-HW-Group32) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
