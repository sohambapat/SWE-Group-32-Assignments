...
|Does your documentation include a "quick start" guide, that provides a short overview of how to use your software with some basic examples of use?|0|No documentation|
|If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software?|0|No documentation|
|Do you provide troubleshooting information that describes the symptoms and step-by-step solutions for problems and error messages?|0|No documentation|
|If your software can be used as a library, package or service by other software, do you provide comprehensive API documentation?|0|No documentation|
|Do you store your documentation under revision control with your source code?|0|No documentation|
|Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation?|0|No documentation|
...
|Are releases tagged in the repository?|3|https://github.com/aadiltajani/CSC510-HW-GRP19/releases/tag/v1.0.0 |
|Question 10.4: Is there a branch of the repository that is always stable? (i.e. tests always pass, code always builds successfully)|0||
|Do you back-up your repository?|3|Most likely saved on local machines for work purposes|
|Do you provide publicly-available instructions for building your software from the source code?|3|https://github.com/aadiltajani/CSC510-HW-GRP19/blob/main/INSTALL.md |
...
|Does your documentation list all third-party dependencies?|3|https://github.com/aadiltajani/CSC510-HW-GRP19/blob/main/requirements.txt |
|Does your documentation list the version number for all third-party dependencies?|2|No documentation, but it is in requirements.txt|
...
|Do you have tests that can be run after your software has been built or deployed to show whether the build or deployment has been successful?|2|There are non-automated tests|
...
|Do you accept contributions (e.g. bug fixes, enhancements, documentation updates, tutorials) from people who are not part of your project?|0|I hope they didn't|
|Do you have a contributions policy?|3|https://github.com/aadiltajani/CSC510-HW-GRP19/blob/main/CONTRIBUTING.md |
...
|Does your website and documentation clearly state the copyright owners of your software and documentation?|3|ReadMe|
|Does each of your source code files include a copyright statement?|0||
|Does your website and documentation clearly state the licence of your software?|3|https://github.com/aadiltajani/CSC510-HW-GRP19/blob/main/LICENSE |
...
|Does each of your source code files include a licence header?|0|No documentation|
|Do you have a recommended citation for your software?|1|https://github.com/aadiltajani/CSC510-HW-GRP19/blob/main/CITATION.md |
...
|Does your website or documentation describe how your project is funded, and the period over which funding is guaranteed?|2|Clearly NCSU repository|
|Do you make timely announcements of the deprecation of components, APIs, etc.?|0|No documentation|
